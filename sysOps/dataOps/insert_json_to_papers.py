...
FIELDS = [
    "ID", "DOI", "DOI2", "Title", "Author", "Year", "Month", "Day", "Volume", "Issue",
    "First_page", "Last_page", "Journal", "ISBN", "ISSNP", "ISSNE", "MD5", "Filesize",
    "TimeAdded", "JOURNALID", "AbstractURL", "Attribute1", "Attribute2", "Attribute3",
    "Attribute4", "Attribute5", "Attribute6", "visible", "PubmedID", "PMC", "PII"
]
